...
|
*/
$config['base_url']	= 'http://localhost:8888/testphp/shopping-cart-keyword/';
...
$config['paypal_return_url']    = $config['base_url'].'cart/payment_success'; //Point to payment_success.php page
